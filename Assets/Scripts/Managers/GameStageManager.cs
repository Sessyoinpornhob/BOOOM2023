...
// 设计这个class是为了在Label和Game之间再增加一个层，便于各种情况下的控制。
    public class GameStageManager : MonoBehaviour
    {
        ...
        [Header("当前阶段")] public int stageNumCurrent = 1;

        [Header("测试用列表")] public List<GameObject> stage01 = new List<GameObject>();
        ...
        // 屎山增加了。
        [Header("存储用列表")] public List<GameObject> stage01Backup = new List<GameObject>();
